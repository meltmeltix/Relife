    ...
    return `
        <div class="tw-flex tw-flex-col tw-p-3.5 tw-gap-2.5 tw-rounded-2xl tw-bg-background-100 dark:tw-bg-background-900">
            <div class="tw-flex tw-items-center tw-w-full tw-gap-1.5 tw-h-6">
                ...
                <a href="/${post.handle}" class="tw-flex-1 tw-overflow-hidden tw-whitespace-nowrap tw-text-ellipsis">
...
function createFocusedPost(post) {
    return `
        <div class="tw-flex tw-flex-col tw-p-3.5 tw-gap-2.5 tw-rounded-2xl">
            <div href="/${post.handle}" class="tw-flex tw-items-center tw-w-full tw-gap-4 tw-h-10">
            ...
            <span>${moment(post.date).format('h:mm · DD MMM YY')}</span>
...
export { createPost, createFocusedPost }